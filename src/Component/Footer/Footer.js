    ...
    return (
        <div className="footer-container">
            <div className="container-fluid">
                <div className="footer-column-container">
                    ...
                    <div className="footer-column">
                        <h4 className="footer-column-header-title">Find N Vibe</h4>
                        <h4 className="footer-column-header-subtitle">Tours and Events Pvt Ltd</h4>
            ...
            <div className="footer-copyright-container">
                <p className='copyright'>copyright to Find N Vibe Tours and Events Pvt Ltd</p>
            </div> 
        </div>
    )
}
