...
function HoneyMoon() {
    return (
        <div className="honeymoon-container" style={{background:`linear-gradient(to right,rgba(0,0,0,.4),rgba(0,0,0,.2)),url($"")`, backgroundSize: 'cover' , backgroundPosition: '0 -550px' ,  backgroundRepeat: 'no-repeat'}}>
